X1 = [];
clearvars -except cal_sbx_F33434_sl1 cal_sbx_F33434_sl2 cal_sbx_F372B8_sl1 cal_sbx_F372B8_sl2 cal_ubx_3139672;
close all;
preang1 = [];
preang2 = [];
preang3 = [];
...
%csv_tmp=save_csi_data{1,1}(1,1:168);
    fid1 = fopen('/home/hsujim/workarea/csv/temp1.csv');
    fid2 = fopen('/home/hsujim/workarea/csv/temp2.csv');
    fid3 = fopen('/home/hsujim/workarea/csv/temp3.csv');
    fid4 = fopen('/home/hsujim/workarea/csv/temp4.csv');
    ...
    ang1 = phase(csi_1)-phase(csi_0);
    ang2 = phase(csi_2)-phase(csi_0);
    ang3 = phase(csi_3)-phase(csi_0);
    
       
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%calibration%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %ubx, just substract constant
    phase_csi_1 = phase(csi_1) - cal_ubx_3139672;
    
        
    %sbx, need consider two kind of csi
    if(mean(diff(phase(csi_2)-phase(csi_0))) > mean(diff(ang1)))
        phase_csi_2 = phase(csi_2) - cal_sbx_F33434_sl2;
    else
        phase_csi_2 = phase(csi_2) - cal_sbx_F33434_sl1;
    end
    if(mean(diff(phase(csi_3)-phase(csi_0))) > mean(diff(ang1)))
        phase_csi_3 = phase(csi_3) - cal_sbx_F372B8_sl2;
    else
        phase_csi_3 = phase(csi_3) - cal_sbx_F372B8_sl1;
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%prepare CSI for estimation%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if(y1(7)==y2(7) && y2(7)==y3(7) && y3(7)==y4(7) && y1(7) == 58 ...filt tx
       && y1(66)==y2(66) && y1(66)==y3(66) && y1(66)==y4(66) ...%same frame
       && y1(121)==y2(121) && y1(121)==y3(121) && y1(121)==y4(121)...
       && y1(119)>30 && y2(119)>30 && y3(119)>30 && y4(119)>30 ...
